...
<div class="container-fluid">
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="@if(isset($edit->id)) {{route('Admin/Board/Update')}} @else {{route('Admin/Board/Store')}} @endif" method="post">
                {{csrf_field()}}
                <input type="hidden" name="Update" value="@if(isset($edit->id)) {{$edit->id}} @endif">
                <div class="card ">
                  <div class="card-header card-header-rose card-header-text">
                    <div class="card-text" style="width: 100%;">
                      <h4 class="card-title">@if(isset($edit->id)) Update Board @else Create Board @endif</h4>
                    </div>
                  </div>
                  <div class="card-body ">
                    <div class="row">
             ...
             <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                  <div class="card-text" style="width: 100%;">
                      <h4 class="card-title">Manage Board</h4>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      @foreach($board as $row)
                        <tr>
                          ...
                          <td>{{$row->Name}}</td>
                          <form action="{{route('Admin/Board/EditSession')}}" method="post">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row" style="padding-bottom: 50px;">
        ...
        <div class="col-sm-4">
          <form action="{{route('Admin/Board/Delete')}}" method="post">
            {{csrf_field()}}
