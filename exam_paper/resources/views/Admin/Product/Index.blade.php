            ...
            <div class="col-md-12">
              <div class="card">
                  ...
                  <div style="background-color: #E93F7A; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>Manage Products
                      <a href="{{route('Admin/Products/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#E93F7A;">Add New</a></h4>
                  </div>
              ...
              @endif
                    ...
                    <table id="datatables" class="table table-no-bordered" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th style="font-weight: bold;">BoardName</th>
                          <th style="font-weight: bold;">Category</th>
                          <th style="font-weight: bold;">SubCategory</th>
                          <th style="font-weight: bold;">Prise</th>
                  ...
                  @foreach($product as $row)
                        <tr>
                          ...
                          <form action="{{route('Admin/Products/EditSession')}}" method="post">
                              {{csrf_field()}}
