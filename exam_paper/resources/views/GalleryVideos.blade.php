          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <ol class="breadcrumb text-center text-black mt-10">
                ...
                <li class="active text-theme-colored">Gallery / Videos</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="heading-line-bottom">
               <h4 class="heading-title"> School Gallery Videos</h4>
            </div>
            ...
            <div class="gallery-isotope default-animation-effect grid-3 gutter-small clearfix" data-lightbox="gallery">
              ...
              <div class="gallery-item">
                @if($row!='0')
                <iframe width="400px" height="300px" src="{{$row->URL}}" frameborder="0" allowfullscreen></iframe>
                @endif
              @endforeach
              </div>
